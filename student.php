                    ...
                    <div class="modal-body">
                      <form method="post" action="">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="editStudent<?=$row["studentid"]?>courseid" aria-describedby="editStudent<?=$row["courseid"]?>Help" name="sCourseID" value="<?=$row['courseid']?>">
                         ...
                         <label for="editStudent<?=$row["studentid"]?>name" class="form-label">First Name</label>
                          <input type="text" class="form-control" id="editStudent<?=$row["studentid"]?>fname" aria-describedby="editStudent<?=$row["courseid"]?>Help" name="sFname" value="<?=$row['fname']?>">
                          ...
                          <input type="text" class="form-control" id="editStudent<?=$row["studentid"]?>lname" aria-describedby="editStudent<?=$row["courseid"]?>Help" name="sLname" value="<?=$row['lname']?>">
                          ...
                          <input type="text" class="form-control" id="editStudent<?=$row["studentid"]?>grade" aria-describedby="editStudent<?=$row["courseid"]?>Help" name="sGrade" value="<?=$row['grade']?>">
